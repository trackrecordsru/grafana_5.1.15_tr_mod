...
export const PanelHeaderMenuTrigger: FC<Props> = ({ children, isAdmin, ...divProps }) => {
  ...
  const cursorStyle = isAdmin ? 'move' : 'default';
  ...
  return (
    <header {...divProps} className="panel-title-container" style={{ cursor: cursorStyle }} onClick={onMenuToggle} onMouseDown={onMouseDown}>
